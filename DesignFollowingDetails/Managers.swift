...
class RoomManager: ObservableObject {
    ...
    private func loadSampleRooms() {
        rooms = [
            ...
            Room(number: "BMO", name: "BMO Brand Room", capacity: 340, currentOccupancy: 0, status: .available, equipment: ["Luxury Bar", "Sound System", "Lighting"], location: "Main Floor", isAvailable: true),
            Room(number: "CB", name: "Crystal Ballroom", capacity: 300, currentOccupancy: 0, status: .available, equipment: ["Stage", "Dance Floor", "Premium Audio"], location: "Main Floor", isAvailable: true)
        ]
    }
